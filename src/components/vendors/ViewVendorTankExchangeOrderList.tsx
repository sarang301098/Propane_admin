...
const ViewVendorTankExchangeOrderList: React.FC<Prop> = ({
  filter,
  setFilter,
  getAction,
}) => {
  ...
  const { vendorOrders, loading } = useSelector(
...
export default ViewVendorTankExchangeOrderList;
