          ...
          <table className="table table-hover nowrap m-0">
            <thead>
              <tr>
                ...
                <th>
                  Vendor Delivery Price <br /> (Per Unit)
                  <OverlayTrigger
                    placement="top"
                    overlay={
                      <Tooltip id={`tooltip01`}>
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  {orderById?.order?.orderType === 2 && "Propane Tank Exchange"}
                </td>
                <td>{orderById?.order?.category?.name || "-"}</td>
                <td>
                  <div className="d-flex align-items-center">
                    <img
                      className="w-40 h-40 min-w-40 rounded-circle o-cover mr-3"
                      src={AmeriGas}
                      alt="Product Logo"
                    />{" "}
                ...
                <td className="text-center">
                  {orderById?.order?.cylinderSize?.cylinderSize
                    ? `${orderById?.order?.cylinderSize?.cylinderSize} lbs`
                    : "-"}
                </td>
                <td>{orderById?.order?.accessory || "-"}</td>
                <td className="text-center">{orderById?.order?.qty || "-"}</td>
                <td>
                  {orderById?.order?.indexPrice != null &&
                  orderById?.order?.indexPrice > -1
...
export default ViewOrderPropaneTankOrderSummary;
