...
import AllOrdersTankList from "./all-orders-tank-list";
...
const AllOrdersTank = () => {
  ...
  const allOrders = useSelector((state: TRootState) => state.orders.orderTankData);
  ...
  return (
    <AllOrders>
      <div className="tab-pane fadeIn active" id="tab-2">
                ...
                <form id="filter-form" className="px-3">
                  ...
                  <div className="form-group">
                    ...
                    <Select
                      ...
                      value={
                        freelanceDriverName
                          ? (freelanceDrivers || []).find((prod) => prod.value === freelanceDriverName) ||
                            null
                          : { value: null, label: "All" }
                      }
        ...
        <Pagination
          ItemsComponent={AllOrdersTankList}
