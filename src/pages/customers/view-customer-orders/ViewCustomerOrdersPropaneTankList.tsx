...
const ViewCustomerOrdersPropaneTankList: React.FC<Prop> = ({ setFilter, filter, setFilterBy }) => {
              ...
              <tr key={order.id}>
                ...
                <td className="table-field-actions">
                  <Dropdown className="btn-group">
                    ...
                    <AppendedMyComponent>
                      <Dropdown.Menu>
                        <Dropdown.Item as={Link} to={`/orders/view-propane-tank/${order.id}/basic-details`}>
...
export default ViewCustomerOrdersPropaneTankList;
