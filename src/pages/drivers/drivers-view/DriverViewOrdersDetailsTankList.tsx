...
const DriverViewOrdersDetailsTankList: React.FC<Prop> = ({ setFilter }) => {
      ...
      <div className="table-responsive">
        <table className="table table-hover m-0">
          ...
          <tbody>
            ...
            ) : driverOrdersTankList.orders &&
              driverOrdersTankList.orders.length > 0 ? (
              driverOrdersTankList.orders.map((order) => (
                <tr key={order?.id}>
                  <td>{order?.orderId}</td>
                  ...
                  <td
                    ...
                    style={{
                      textAlign: !order.vendorName ? "center" : "inherit",
                    }}
                  >
                    {order?.vendorName || "-"}
                  </td>
                  <td className="table-field-actions">
                    <Dropdown className="btn-group">
                      ...
                      <AppendedMyComponent>
                        <Dropdown.Menu>
                          <Dropdown.Item
                            href={`/orders/view-propane-tank/${driverOrderId}/basic-details`}
                          >
...
export default DriverViewOrdersDetailsTankList;
