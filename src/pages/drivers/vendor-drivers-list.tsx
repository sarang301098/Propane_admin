...
const VendorDriversList: React.FC<Prop> = ({
  getAction,
  filter,
  setFilter,
}) => {
  ...
  const vendorDriversList = useSelector(
  ...
  const driverDeleteHandler = () => {
    ...
    dispatch(
      deleteDriverActionThunk(id, false, isLastPage ? getAction : undefined)
    );
  ...
  const changeVendorDriverStatusHandler = () => {
    dispatch(updateDriverActionThunk(isActive, id, false));
    setShowChangeStatusAlert(false);
  };
  const changeVendorDriverApprovalHandler = () => {
    dispatch(updateDriverApprovalActionThunk(status, id, false));
      ...
      <div className="table-responsive">
        <table className="table table-hover m-0">
          ...
          <tbody>
            ...
            ) : vendorDriversList?.drivers &&
              vendorDriversList?.drivers?.length > 0 ? (
              vendorDriversList?.drivers?.map((driver) => (
                <tr key={driver?.id}>
                  <td>
                    <div className="media">
                      <img
        ...
        <SweetAlert
          ...
          customButtons={
            <React.Fragment>
              ...
              <button
                className="btn btn-danger min-w-100"
                onClick={() => changeVendorDriverStatusHandler()}
              >
                Yes
              </button>
            </React.Fragment>
        ...
        <SweetAlert
          ...
          customButtons={
            <React.Fragment>
              ...
              <button
                className="btn btn-danger min-w-100"
                onClick={() => changeVendorDriverApprovalHandler()}
              >
                Yes
              </button>
            </React.Fragment>
...
export default VendorDriversList;
